  ...
  <body>
    <header>
      ...
      <nav class="nav">
        <a href="#" class="nav__logo"
          >
          <img
            src="./assets/imgs/pineapple-logo.svg"
            alt="pineapple company logo"
            class="big-logo"
        />
        <img src="./assets/imgs/pineapple.svg" alt="pineapple company logo" class="small-logo">
      </a>
      ...
      <!------------ nav end ------------>
      <div class="pineapple-img-container">
        <img
        src="./assets/imgs/image_summer.png"
    ...
    <main>
      ...
      <section id="subscribe-form" class="subscribe">
        ...
        <!-- Form !!!!!!!!!-->
        <form action = "includes/singup.php" class = "form" method="post" id="form" >
          <div class="input-wrapper subscribe__input-wrapper">
            <input
              type="email"
              name="email"
            ...
            ?>
            <!-- ############################### -->
            <button class="input-wrapper__arrow" id="submit">
              <svg
                width="24"
                height="14"
                viewBox="0 0 24 14"
          ...
          <div id="email_validate" class="errors"></div>
          <div id="terms_validate" class="errors"></div>

          <input type="checkbox" name="terms" id="terms"/>
          <label for="terms" class="subscribe__checkbox">
